...
\renewcommand{\j}{j\mkern1mu} % Straight-up iotas
...
\graphicspath{{data/microscopy/figures/}{data/opantennas/figures/}}
...
%bibliography.tex.
\bibliography{references/zubairy,references/Optical_Antennas}
