...
\usepackage{microtype} % Enfore borders
...
\renewcommand{\j}{\mathrm{j}\mkern1mu} % Straight-up exponential
...
\graphicspath{{data/microscopy/figures/}{data/opantennas/figures/}{data/sommint/figures/}{data/poles/figures/}}
...
\renewcommand{\tamumanuscripttitle}{Surface wave supporting structures in the terahertz and optical frequency domains}
...
\newcommand{\tamumembertwo}{Chin Bing Su}
...
\include{data/intro}
\include{data/OpAntennas/bchapter}
\include{data/SommInt/som_int}
\input{data/poles/multilayered_roots}
\input{data/microscopy/new_sim_portion}
