...
\begin{document}
  \begin{tikzpicture}
    ...
    \draw [line width=0.5mm,arrows={-latex}] (2, 2) -- (2, 2.7);
    \draw [line width=0.5mm,arrows={-latex}] (2, 2.4) -- (2, 3);
    \node at (2.5, 2.5) {${\tilde{M}_y}$};
    % Draw the equivalent TL
    % Insert Source
    \draw[line width=0.25mm] (12,0) -- (12,5);
    \draw[line width=0.25mm]
    (7,0) to[american voltage source,l_=$v^{TE}{=}-\tilde{M}_y$] (7,5);
