\chapter{\uppercase{Surface waves extraction of a conductive sheet embedded in a multilayer environment}}
...
The 2DEG which is only a few atoms wide in thickness, is a highly conductive region with an abundance of free electrons, which can be expressed in terms of a surface conductivity \cite{Burke2000},
%
\begin{equation}
...
\begin{figure}[t!]
  ...
  \input{data/poles/figures/multilayers.pdf_tex}
...
\begin{figure}[t!]
  ...
  \input{data/poles/figures/zplane.pdf_tex}
...
To remove the branch point singularities, the complex z-plane is typically mapped to another plane $\zeta$, by a transformation that unfolds the Riemann surface. For example, a trigonometric transformation such as \cite{Michalski2006,Polimeridis_2007},
%
\begin{equation}
  \begin{split}
    z &\mapsto \zeta \\
...
\begin{figure}[!htbp]
  ...
  \input{data/poles/figures/gated.pdf_tex}
  \label{fig:gated}} \hfil
  \subfloat[]{\def\svgwidth{.3\linewidth}
  \input{data/poles/figures/ungated.pdf_tex}
  \label{fig:ungated}} \hfil
  \subfloat[]{\def\svgwidth{.3\linewidth}
  \input{data/poles/figures/backgated.pdf_tex}
...
\begin{sidewaysfigure}
  \centering
  \subfloat[]{\includegraphics[height = 2.8in]{gated_disp1.tikz}
  \label{fig:gated_hf_lt}}
  \subfloat[]{\includegraphics[height = 2.8in]{backgated_disp.tikz}
  \label{fig:backgated_hf_lt}}
  \subfloat[]{\includegraphics[height = 2.8in]{ungated_disp.tikz}
...
\begin{sidewaysfigure}
  \centering
  \subfloat[]{\includegraphics[height = 2.8in]{gated_disp_lossy.tikz}
  \label{fig:gated_hf_ht}}
  \subfloat[]{\includegraphics[height = 2.8in]{backgated_disp_lossy.tikz}
  \label{fig:backgated_hf_ht}}
  \subfloat[]{\includegraphics[height = 2.8in]{ungated_disp_lossy.tikz}
